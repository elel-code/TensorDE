...
use crate::ui::theme::{NEUTRAL_ICON_COLOR, PROPERTIES_ICON_COLOR, ShellTheme, UiColor};
use crate::{
...
#[path = "paint/glyph.rs"]
mod glyph;
use glyph::{push_context_menu_icon, push_context_menu_shadow};
