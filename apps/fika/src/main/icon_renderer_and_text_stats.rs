impl IconRenderer {
    ...
    fn set_dmabuf_import_state(
        &mut self,
        supported: bool,
        plan: Option<crate::ui::render::dmabuf::DmabufImportPlan>,
    ) {
    ...
    fn upload(
        ...
        for slot in &mut frame.slots {
            ...
            if source == crate::ui::render::dmabuf::ExternalTextureSource::DmabufImport {
    ...
    fn upload_slot_texture(
        ...
        wgpu::Texture,
        crate::ui::render::dmabuf::ExternalTextureSource,
    )> {
        use crate::ui::render::dmabuf::{ExternalTextureSource, acquire_external_texture};
