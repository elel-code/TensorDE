impl WgpuState {
    ...
    fn from_surface_parts(
        ...
        let dmabuf_import_supported =
            crate::ui::render::dmabuf::adapter_supports_dmabuf_import(&adapter)
                && device
                    .features()
    ...
    pub(crate) fn dmabuf_readiness(
        ...
        event_loop: &ActiveEventLoop,
        surface: Option<WindowId>,
    ) -> crate::ui::render::dmabuf::DmabufReadiness {
        ...
        crate::ui::render::dmabuf::assess_readiness(
            self.dmabuf_import_supported,
            wayland_global,
            feedback.as_ref(),
        )
    ...
    pub(crate) fn dmabuf_import_plan(
        ...
        event_loop: &ActiveEventLoop,
        surface: Option<WindowId>,
    ) -> Option<crate::ui::render::dmabuf::DmabufImportPlan> {
    ...
    pub(crate) fn import_dmabuf_texture(
        &self,
        desc: crate::ui::render::dmabuf::DmabufImportDesc,
    ) -> Result<wgpu::Texture, crate::ui::render::dmabuf::DmabufImportError> {
        if !self.dmabuf_import_supported {
            return Err(crate::ui::render::dmabuf::DmabufImportError::FeatureUnavailable);
        }
        crate::ui::render::dmabuf::import_dmabuf_texture(&self.device, desc)
    }
    ...
    pub(crate) fn import_dmabuf_with_plan(
        &self,
        plan: crate::ui::render::dmabuf::DmabufImportPlan,
        width: u32,
        height: u32,
    ...
    pub(crate) fn acquire_external_texture(
        ...
        width: u32,
        height: u32,
        plane: Option<crate::ui::render::dmabuf::DmabufImportPlane>,
        label: Option<&'static str>,
    ) -> Result<
        crate::ui::render::dmabuf::ExternalTexture,
        crate::ui::render::dmabuf::DmabufImportError,
    > {
        let plan = self.dmabuf_import_plan(event_loop, surface);
        crate::ui::render::dmabuf::acquire_external_texture(
            &self.device,
            plan,
            width,
            height,
