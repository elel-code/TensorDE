...
pub(in crate::renderer::native_vulkan::vulkan) const ROADMAP_2026_PROFILE_NAME: &str =
    "VP_KHR_roadmap_2026";
pub(in crate::renderer::native_vulkan::vulkan) const ROADMAP_2026_PROFILE_REVISION: u32 = 11;
pub(in crate::renderer::native_vulkan::vulkan) const ROADMAP_2026_API_VERSION: Version =
    Version::new(1, 4, 328);
pub(in crate::renderer::native_vulkan::vulkan) const ROADMAP_2026_SOURCE_REFERENCE: &str =
    "Khronos VP_KHR_roadmap.json revision 11 (2026-01-28)";

pub(in crate::renderer::native_vulkan::vulkan) const ROADMAP_2026_REQUIRED_INSTANCE_EXTENSIONS: &[&str] = &[
    "VK_KHR_surface",
    "VK_KHR_get_surface_capabilities2",
    "VK_KHR_surface_maintenance1",
];

pub(in crate::renderer::native_vulkan::vulkan) const GILDER_ROADMAP_2026_REQUIRED_INSTANCE_EXTENSIONS: &[&str] = &[
    "VK_KHR_surface",
...
pub(in crate::renderer::native_vulkan::vulkan) const ROADMAP_2026_REQUIRED_DEVICE_EXTENSIONS: &[&str] = &[
...
pub(in crate::renderer::native_vulkan::vulkan) struct Roadmap2026CoreRequirementProbe {
    pub missing_features: Vec<&'static str>,
    pub missing_properties: Vec<&'static str>,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub(in crate::renderer::native_vulkan::vulkan) struct Roadmap2026DeviceRequirementProbe {
...
impl Roadmap2026CoreRequirementProbe {
    pub fn ready(&self) -> bool {
        self.missing_features.is_empty() && self.missing_properties.is_empty()
    }
}

pub(in crate::renderer::native_vulkan::vulkan) fn roadmap_2026_api_version_ready(
    api_version: u32,
) -> bool {
    api_version >= u32::from(ROADMAP_2026_API_VERSION)
}

pub(in crate::renderer::native_vulkan::vulkan) fn query_roadmap_2026_device_requirements(
    instance: &Instance,
...
pub(in crate::renderer::native_vulkan::vulkan) fn query_roadmap_2026_core_requirements(
    instance: &Instance,
    physical_device: vk::PhysicalDevice,
    ...
    require_feature!(core.draw_indirect_first_instance, "drawIndirectFirstInstance");
    ...
    require_feature!(core.shader_image_gather_extended, "shaderImageGatherExtended");
    ...
    require_feature!(vulkan11_features.shader_draw_parameters, "shaderDrawParameters");
    require_feature!(
    ...
    for (supported, name) in [
        ...
        (vulkan12_features.imageless_framebuffer, "imagelessFramebuffer"),
        (
        ...
        (vulkan12_features.buffer_device_address, "bufferDeviceAddress"),
        (
        ...
        (vulkan12_features.runtime_descriptor_array, "runtimeDescriptorArray"),
    ...
    for (supported, name) in [
        ...
        (vulkan13_features.subgroup_size_control, "subgroupSizeControl"),
        (vulkan13_features.compute_full_subgroups, "computeFullSubgroups"),
        (
    ...
    for (supported, name) in [
        (vulkan14_features.shader_subgroup_rotate, "shaderSubgroupRotate"),
        (vulkan14_features.shader_expect_assume, "shaderExpectAssume"),
        (vulkan14_features.shader_float_controls2, "shaderFloatControls2"),
        ...
        (vulkan14_features.stippled_smooth_lines, "stippledSmoothLines"),
        (
    ...
    require_min!(limits.max_image_dimension_cube, 8192, "maxImageDimensionCube");
    require_min!(limits.max_image_array_layers, 2048, "maxImageArrayLayers");
    require_min!(limits.max_uniform_buffer_range, 65536, "maxUniformBufferRange");
    require_max!(limits.buffer_image_granularity, 4096, "bufferImageGranularity");
    require_min!(limits.max_per_stage_descriptor_samplers, 64, "maxPerStageDescriptorSamplers");
    require_min!(limits.max_per_stage_descriptor_uniform_buffers, 200, "maxPerStageDescriptorUniformBuffers");
    require_min!(limits.max_per_stage_descriptor_storage_buffers, 200, "maxPerStageDescriptorStorageBuffers");
    require_min!(limits.max_per_stage_descriptor_sampled_images, 200, "maxPerStageDescriptorSampledImages");
    require_min!(limits.max_per_stage_descriptor_storage_images, 16, "maxPerStageDescriptorStorageImages");
    require_min!(limits.max_per_stage_descriptor_input_attachments, 8, "maxPerStageDescriptorInputAttachments");
    require_min!(limits.max_per_stage_resources, 200, "maxPerStageResources");
    require_min!(limits.max_descriptor_set_samplers, 576, "maxDescriptorSetSamplers");
    require_min!(limits.max_descriptor_set_uniform_buffers, 1800, "maxDescriptorSetUniformBuffers");
    require_min!(limits.max_descriptor_set_storage_buffers, 1800, "maxDescriptorSetStorageBuffers");
    require_min!(limits.max_descriptor_set_sampled_images, 1800, "maxDescriptorSetSampledImages");
    require_min!(limits.max_descriptor_set_storage_images, 144, "maxDescriptorSetStorageImages");
    require_min!(limits.max_descriptor_set_input_attachments, 8, "maxDescriptorSetInputAttachments");
    require_min!(limits.max_fragment_combined_output_resources, 16, "maxFragmentCombinedOutputResources");
    require_min!(limits.max_compute_work_group_invocations, 256, "maxComputeWorkGroupInvocations");
    for (value, required, name) in [
        (limits.max_compute_work_group_size[0], 256, "maxComputeWorkGroupSize[0]"),
        (limits.max_compute_work_group_size[1], 256, "maxComputeWorkGroupSize[1]"),
        (limits.max_compute_work_group_size[2], 64, "maxComputeWorkGroupSize[2]"),
    ] {
        if value < required {
            missing_properties.push(name);
        }
    ...
    require_property!(limits.timestamp_compute_and_graphics, "timestampComputeAndGraphics");
    require_min!(limits.max_bound_descriptor_sets, 7, "maxBoundDescriptorSets");
    require_min!(limits.max_vertex_output_components, 124, "maxVertexOutputComponents");
    require_min!(limits.max_tessellation_control_per_vertex_input_components, 128, "maxTessellationControlPerVertexInputComponents");
    require_min!(limits.max_tessellation_control_per_vertex_output_components, 128, "maxTessellationControlPerVertexOutputComponents");
    require_min!(limits.max_tessellation_control_total_output_components, 4096, "maxTessellationControlTotalOutputComponents");
    require_min!(limits.max_tessellation_evaluation_input_components, 128, "maxTessellationEvaluationInputComponents");
    require_min!(limits.max_tessellation_evaluation_output_components, 128, "maxTessellationEvaluationOutputComponents");
    require_min!(limits.max_geometry_output_components, 128, "maxGeometryOutputComponents");
    require_min!(limits.max_fragment_input_components, 112, "maxFragmentInputComponents");
    require_min!(limits.max_fragment_output_attachments, 8, "maxFragmentOutputAttachments");
    require_min!(limits.max_compute_shared_memory_size, 32768, "maxComputeSharedMemorySize");
    require_min!(limits.sub_pixel_precision_bits, 8, "subPixelPrecisionBits");
    require_min!(limits.max_viewport_dimensions[0], 8192, "maxViewportDimensions[0]");
    require_min!(limits.max_viewport_dimensions[1], 8192, "maxViewportDimensions[1]");
    ...
    require_min!(vulkan11_properties.max_multiview_view_count, 6, "maxMultiviewViewCount");
    require_min!(vulkan11_properties.max_multiview_instance_index, 134217727, "maxMultiviewInstanceIndex");
    ...
    for (value, required, name) in [
        (vulkan12_properties.max_per_stage_descriptor_update_after_bind_samplers, 500000, "maxPerStageDescriptorUpdateAfterBindSamplers"),
        (vulkan12_properties.max_per_stage_descriptor_update_after_bind_uniform_buffers, 12, "maxPerStageDescriptorUpdateAfterBindUniformBuffers"),
        (vulkan12_properties.max_per_stage_descriptor_update_after_bind_storage_buffers, 500000, "maxPerStageDescriptorUpdateAfterBindStorageBuffers"),
        (vulkan12_properties.max_per_stage_descriptor_update_after_bind_sampled_images, 500000, "maxPerStageDescriptorUpdateAfterBindSampledImages"),
        (vulkan12_properties.max_per_stage_descriptor_update_after_bind_storage_images, 500000, "maxPerStageDescriptorUpdateAfterBindStorageImages"),
        (vulkan12_properties.max_per_stage_descriptor_update_after_bind_input_attachments, 7, "maxPerStageDescriptorUpdateAfterBindInputAttachments"),
        (vulkan12_properties.max_per_stage_update_after_bind_resources, 500000, "maxPerStageUpdateAfterBindResources"),
        (vulkan12_properties.max_descriptor_set_update_after_bind_samplers, 500000, "maxDescriptorSetUpdateAfterBindSamplers"),
        (vulkan12_properties.max_descriptor_set_update_after_bind_uniform_buffers, 72, "maxDescriptorSetUpdateAfterBindUniformBuffers"),
        (vulkan12_properties.max_descriptor_set_update_after_bind_uniform_buffers_dynamic, 8, "maxDescriptorSetUpdateAfterBindUniformBuffersDynamic"),
        (vulkan12_properties.max_descriptor_set_update_after_bind_storage_buffers, 500000, "maxDescriptorSetUpdateAfterBindStorageBuffers"),
        (vulkan12_properties.max_descriptor_set_update_after_bind_storage_buffers_dynamic, 4, "maxDescriptorSetUpdateAfterBindStorageBuffersDynamic"),
        (vulkan12_properties.max_descriptor_set_update_after_bind_sampled_images, 500000, "maxDescriptorSetUpdateAfterBindSampledImages"),
        (vulkan12_properties.max_descriptor_set_update_after_bind_storage_images, 500000, "maxDescriptorSetUpdateAfterBindStorageImages"),
        (vulkan12_properties.max_descriptor_set_update_after_bind_input_attachments, 7, "maxDescriptorSetUpdateAfterBindInputAttachments"),
    ] {
        if value < required {
            missing_properties.push(name);
        }
    ...
    for (value, required, name) in [
        (vulkan13_properties.max_buffer_size, 1073741824, "maxBufferSize"),
        (u64::from(vulkan13_properties.max_inline_uniform_block_size), 256, "maxInlineUniformBlockSize"),
        (u64::from(vulkan13_properties.max_per_stage_descriptor_inline_uniform_blocks), 4, "maxPerStageDescriptorInlineUniformBlocks"),
        (u64::from(vulkan13_properties.max_per_stage_descriptor_update_after_bind_inline_uniform_blocks), 4, "maxPerStageDescriptorUpdateAfterBindInlineUniformBlocks"),
        (u64::from(vulkan13_properties.max_descriptor_set_inline_uniform_blocks), 4, "maxDescriptorSetInlineUniformBlocks"),
        (u64::from(vulkan13_properties.max_descriptor_set_update_after_bind_inline_uniform_blocks), 4, "maxDescriptorSetUpdateAfterBindInlineUniformBlocks"),
        (u64::from(vulkan13_properties.max_inline_uniform_total_size), 256, "maxInlineUniformTotalSize"),
    ] {
        if value < required {
            missing_properties.push(name);
        }
...
mod tests {
    ...
    fn roadmap_2026_api_floor_is_the_profile_version_not_vulkan_1_4_zero() {
        ...
        assert!(!roadmap_2026_api_version_ready(u32::from(Version::new(1, 4, 327))));
        assert!(roadmap_2026_api_version_ready(u32::from(ROADMAP_2026_API_VERSION)));
    }

    #[test]
    fn roadmap_2026_required_extensions_include_inherited_profile_capabilities() {
        assert!(
            ROADMAP_2026_REQUIRED_DEVICE_EXTENSIONS.contains(&"VK_KHR_global_priority")
        );
        assert!(
