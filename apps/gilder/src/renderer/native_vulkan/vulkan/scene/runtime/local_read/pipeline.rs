...
#[derive(Debug, Clone)]
pub(in crate::renderer::native_vulkan::vulkan::scene::runtime) struct SceneLocalReadPipelineMetadata<
    'a,
> {
...
impl<'a> SceneLocalReadPipelineMetadata<'a> {
    pub(in crate::renderer::native_vulkan::vulkan::scene::runtime) fn new(
        ...
        validate_unique_optional_values(
            color_attachment_locations,
    ...
    pub(in crate::renderer::native_vulkan::vulkan::scene::runtime) fn output_only(
        descriptor_access: &ScenePipelineShaderDescriptorAccess,
        color_attachment_formats: &[TextureFormat],
        color_attachment_locations: &[Option<u32>],
    ) -> Result<Self, String> {
    ...
    pub(in crate::renderer::native_vulkan::vulkan::scene::runtime) fn local_read_fragment_spirv(
        &self,
    ) -> Option<&'a [u32]> {
        self.shader.map(|shader| shader.fragment_spirv)
    }

    pub(in crate::renderer::native_vulkan::vulkan::scene::runtime) fn color_attachment_formats(
        &self,
    ) -> &[TextureFormat] {
        &self.color_attachment_formats
    }

    pub(in crate::renderer::native_vulkan::vulkan::scene::runtime) fn active_color_attachments(
        &self,
    ) -> Vec<bool> {
    ...
    pub(in crate::renderer::native_vulkan::vulkan::scene::runtime) fn input_attachment_binding(
        &self,
        slot: u32,
    ) -> Option<u32> {
        self.shader?
...
pub(in crate::renderer::native_vulkan::vulkan::scene::runtime) fn validate_scene_local_read_shader_variant<
    'a,
>(
    descriptor_access: &ScenePipelineShaderDescriptorAccess,
    shader: Option<&'a BuiltinSceneLocalReadShader>,
...
fn validate_unique_optional_values(
    values: &[Option<u32>],
    label: &str,
) -> Result<(), String> {
    validate_unique_values(
