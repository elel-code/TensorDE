...
use crate::renderer::native_vulkan::vulkan::scene::runtime::sampled_binding::SceneSampledImageBindingPlan;

#[cfg(test)]
mod tests;

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(in crate::renderer::native_vulkan::vulkan::scene::runtime) enum SharedSceneEffectCopySource {
    SceneColor,
    PhysicalSlot(u32),
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(in crate::renderer::native_vulkan::vulkan::scene::runtime) enum SharedSceneEffectLoadOp {
    Load,
    Clear,
    Discard,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(in crate::renderer::native_vulkan::vulkan::scene::runtime) enum SharedSceneEffectCommandKind {
    Copy {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(in crate::renderer::native_vulkan::vulkan::scene::runtime) struct SharedSceneEffectCommand {
...
pub(in crate::renderer::native_vulkan::vulkan::scene::runtime) struct SharedSceneEffectExecutionPlan
{
    pub reference_phase: usize,
    pub commands: Vec<SharedSceneEffectCommand>,
}

pub(in crate::renderer::native_vulkan::vulkan::scene::runtime) fn shared_scene_effect_execution_plans(
