...
pub(in crate::renderer::native_vulkan::vulkan::scene::runtime) fn apply_scene_video_draw_semantics(
...
mod tests {
    ...
    fn overlapping_video_bindings_are_rejected_instead_of_guessed() {
        let error = video_draw_media_instances(3, &[binding(2, 0, 2), binding(3, 1, 2)])
            .unwrap_err();
