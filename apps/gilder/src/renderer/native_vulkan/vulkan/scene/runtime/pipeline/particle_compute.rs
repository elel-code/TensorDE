...
impl SceneParticleComputePipeline {
    pub(in crate::renderer::native_vulkan) fn pipeline(&self) -> &MachineCodeComputePipeline {
        &self.pipeline
    }
...
fn create_particle_compute_pipeline(
    ...
    let module = device
        .create_shader_module(ShaderModuleDescriptor {
            label: Some("gilder-particle-compute".into()),
    ...
    device
        .create_machine_code_compute_pipeline(&MachineCodeComputePipelineDescriptor {
            pipeline: ComputePipelineDescriptor {
                label: Some("gilder-particle-compute"),
