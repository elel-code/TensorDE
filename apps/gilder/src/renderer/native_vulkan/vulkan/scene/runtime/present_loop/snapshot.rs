Ok(NativeVulkanVulkanaliaScenePresentSnapshot {
    ...
    scene_color_rasterization_samples: if metrics.scene_color_msaa_enabled { "4x" } else { "1x" },
    uses_multisampled_render_to_single_sampled: metrics.multisampled_render_to_single_sampled_enabled,
    uses_explicit_scene_color_msaa_resolve: metrics.scene_color_msaa_enabled
        && !metrics.multisampled_render_to_single_sampled_enabled,
    scene_color_msaa_memory_bytes: metrics.scene_color_msaa_memory_bytes,
    frame_slot_count,
    effect_target_physical_image_count: metrics.effect_target_physical_image_count,
    effect_target_memory_bytes: metrics.effect_target_memory_bytes,
    effect_target_dynamic_rendering_recorded: metrics.effect_target_dynamic_rendering_recorded,
    effect_target_dynamic_rendering_pass_count: metrics.effect_target_dynamic_rendering_pass_count,
    effect_batch_count: metrics.effect_batch_count,
    effect_batch_instance_count: metrics.effect_batch_instance_count,
    effect_batch_field_count: metrics.effect_batch_field_count,
    effect_target_copy_command_count: metrics.effect_target_copy_command_count,
    effect_target_swap_reference_count: metrics.effect_target_swap_reference_count,
    effect_target_mesh_draw_count: metrics.effect_target_mesh_draw_count,
    effect_target_discard_load_count: metrics.effect_target_discard_load_count,
    scene_color_mesh_draw_count: metrics.scene_color_mesh_draw_count,
    scene_color_recorded_mesh_draw_count: metrics.scene_color_recorded_mesh_draw_count,
    scene_color_attachment_clear_draw_count: metrics.scene_color_attachment_clear_draw_count,
    scene_color_attachment_clear_frame_count,
    descriptor_model: "VK_EXT_descriptor_heap",
    descriptor_heap_resource_count: metrics.descriptor_heap_resource_count,
    descriptor_heap_sampler_count: metrics.descriptor_heap_sampler_count,
    vertex_buffer_bytes: metrics.vertex_buffer_bytes,
    index_buffer_bytes: metrics.index_buffer_bytes,
    transform_uniform_bytes: metrics.transform_uniform_bytes,
    material_uniform_bytes: metrics.material_uniform_bytes,
    scene_owned_uniform_bytes: metrics.scene_owned_uniform_bytes,
    ...
    skinning_storage_bytes: metrics.skinning_storage_bytes,
    resource_residency: metrics.resource_residency,
    scene_texture_image_count: metrics.scene_texture_image_count,
    scene_texture_memory_bytes: metrics.scene_texture_memory_bytes,
    ...
    sampled_fallback_texture_count: metrics.sampled_fallback_texture_count,
    sampled_fallback_descriptor_count: metrics.sampled_fallback_descriptor_count,
    sampled_scene_texture_descriptor_count: metrics.sampled_scene_texture_descriptor_count,
    sampled_scene_color_snapshot_descriptor_count: metrics.sampled_scene_color_snapshot_descriptor_count,
    sampled_effect_target_descriptor_count: metrics.sampled_effect_target_descriptor_count,
    effect_target_reference_cycle_length: metrics.effect_target_reference_cycle_length,
    ...
    scene_pipeline_count: metrics.scene_pipeline_count,
    mesh_draw_count: metrics.mesh_draw_count,
    particle_instance_capacity: metrics.particle_instance_capacity,
    particle_gpu_emitter_count: metrics.particle_gpu_emitter_count,
    particle_gpu_total_capacity: metrics.particle_gpu_total_capacity,
    particle_gpu_state_bytes: metrics.particle_gpu_state_bytes,
    particle_gpu_indirect_bytes: metrics.particle_gpu_indirect_bytes,
    particle_gpu_frame_time_bytes: metrics.particle_gpu_frame_time_bytes,
    particle_gpu_device_local: metrics.particle_gpu_device_local,
    particle_compute_pipeline_created: metrics.particle_compute_pipeline_created,
    particle_compute_dispatch_enabled: metrics.particle_compute_pipeline_created,
    mesh_draw_recorded,
    command_order,
