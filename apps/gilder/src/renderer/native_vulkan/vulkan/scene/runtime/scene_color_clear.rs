...
pub(super) struct SceneGpuSceneColorClear {
    pub graph_index: u32,
    pub draw_index: u32,
    pub color: NativeVulkanClearColor,
}
...
fn resolve_scene_color_attachment_clear_contract(
    ...
    if !native_vulkan_scene_shader_for_key(shader_key)
    ...
    Ok(SceneGpuSceneColorClear {
        ...
        color: NativeVulkanClearColor { r, g, b, a },
    })
}
...
mod tests {
    ...
    fn clear_replaces_only_its_single_typed_draw_range() {
        let clear = SceneGpuSceneColorClear {
            graph_index: 3,
            draw_index: 7,
            color: NativeVulkanClearColor::default(),
        };
