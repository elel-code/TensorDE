...
use super::{
    SceneFrameBufferUpdate, SceneFrameCpuTiming, elapsed_optional_micros, update_draw_visibility,
    update_effect_draw_pipelines,
};

impl SharedSceneGpuResources {
    #[allow(clippy::too_many_arguments)]
    pub(in crate::renderer::native_vulkan::vulkan::scene::runtime) fn update_semantic_frame(
        &mut self,
