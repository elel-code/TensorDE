...
use tensor_files_core::{DesktopLaunchPlan, FileTransferMode, TrashViewOperation};
...
///
/// Call sites should build a request and call `TensorFilesApp::submit_operation_request`
