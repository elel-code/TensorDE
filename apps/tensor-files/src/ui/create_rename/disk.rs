use tensor_files_core::{PrivilegedCommand, file_ops};

use super::{CreateEntryKind, CreateEntryRequest, RenameEntryRequest};
use crate::ui::privilege::{ShellPrivilegeOutcome, run_privileged_command};
...
pub(crate) fn create_entry_on_disk(request: &CreateEntryRequest) -> Result<(), String> {
    use tensor_files_core::run_operation_task;
