...
pub(crate) const BUILTIN_ARK_COMPRESS_TAR_GZ_ACTION_ID: &str =
    "tensor-files.builtin.ark.compress-tar-gz";
pub(crate) const BUILTIN_ARK_COMPRESS_ZIP_ACTION_ID: &str = "tensor-files.builtin.ark.compress-zip";
pub(crate) const BUILTIN_ARK_COMPRESS_ACTION_ID: &str = "tensor-files.builtin.ark.compress";
pub(crate) const BUILTIN_ARK_EXTRACT_HERE_ACTION_ID: &str = "tensor-files.builtin.ark.extract-here";
pub(crate) const BUILTIN_ARK_EXTRACT_AND_TRASH_ACTION_ID: &str =
    "tensor-files.builtin.ark.extract-and-trash";
pub(crate) const BUILTIN_ARK_EXTRACT_TO_ACTION_ID: &str = "tensor-files.builtin.ark.extract-to";
