...
use tensor_files_core::{
    DevicePlaceOperation, MimeApplication, ServiceMenuAction, ViewPoint, file_ops, is_network_path,
    is_network_root_path,
};

use crate::ui::create_rename::CreateEntryKind;
...
mod service_menu;
#[cfg(test)]
pub(crate) use service_menu::service_menu_action_item;
use service_menu::{
    service_menu_group_items, service_menu_has_more_actions, service_menu_more_items,
    service_menu_root_items,
};
