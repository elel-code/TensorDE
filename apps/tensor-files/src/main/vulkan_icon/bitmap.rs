...
pub(super) fn compile_scale_graph(queue_family: u32) -> Result<CompiledGraph, String> {
    ...
    graph.add_pass(RenderPass {
        ...
        label: "tensor-files-vulkan-icon-scale-source-upload".into(),
        depends_on: Vec::new(),
    ...
    graph.add_pass(RenderPass {
        ...
        label: "tensor-files-vulkan-icon-scale-target-clear".into(),
        depends_on: Vec::new(),
        resources: vec![ResourceUse {
    ...
    graph.add_pass(RenderPass {
        id: SCALE_BLIT,
        label: "tensor-files-vulkan-icon-scale-blit".into(),
    ...
    graph.add_pass(RenderPass {
        id: SCALE_SAMPLE,
        label: "tensor-files-vulkan-icon-scale-sample".into(),
