...
impl VulkanIconRenderer {
    pub(crate) fn new(
        ...
        let resource_heap = device
            .create_descriptor_heap(&DescriptorHeapDescriptor {
                label: Some("tensor-files-vulkan-icon-resource-heap".into()),
        ...
        let sampler_heap = device
            .create_descriptor_heap(&DescriptorHeapDescriptor {
                label: Some("tensor-files-vulkan-icon-sampler-heap".into()),
        ...
        let vertices = DynamicBuffer::new(
            ...
            DynamicBufferDescriptor {
                label: Some("tensor-files-vulkan-icon-vertices".into()),
    ...
    fn create_folder_preview_texture(
        ...
        let image = create_rgba_image(
            allocator,
            "tensor-files-vulkan-folder-preview",
            side,
            side,
        ...
        let view = image
            .create_view(&ImageViewDescriptor {
                label: Some("tensor-files-vulkan-folder-preview-view".into()),
    ...
    fn render_bitmap_child(
        ...
        let image = create_rgba_image(
            allocator,
            "tensor-files-vulkan-preview-child",
            width,
            height,
        ...
        let view = image
            .create_view(&ImageViewDescriptor {
                label: Some("tensor-files-vulkan-preview-child-view".into()),
                dimension: ImageViewDimension::D2,
                format: image.format(),
                components: ComponentMapping::IDENTITY,
                subresource_range: image.full_subresource_range(TextureAspects::COLOR),
    ...
    fn create_texture(
        ...
        let image = create_rgba_image(
            allocator,
            "tensor-files-vulkan-resident-icon",
            width,
            height,
            TextureUsages::COPY_DESTINATION | TextureUsages::SAMPLED,
        )?;
        let view = image
            .create_view(&ImageViewDescriptor {
                label: Some("tensor-files-vulkan-resident-icon-view".into()),
                dimension: ImageViewDimension::D2,
                format: image.format(),
                components: ComponentMapping::IDENTITY,
                subresource_range: image.full_subresource_range(TextureAspects::COLOR),
    ...
    fn scale_bitmap(
        ...
        let source = create_rgba_image(
            allocator,
            "tensor-files-vulkan-icon-scale-source",
            bitmap.width,
            bitmap.height,
