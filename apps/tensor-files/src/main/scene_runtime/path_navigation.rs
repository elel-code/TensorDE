impl ShellScene {
    ...
    fn log_loaded_path_for_pane(
        ...
        tensor_files_log!(
            "[tensor-files] pane={} path={} entries={} dirs={} files={} load={}us changes={}",
            pane.as_str(),
            state.path.display(),
            state.entries.len(),
            dir_count,
    ...
    fn log_reloaded_path_for_pane(
        ...
        tensor_files_log!(
            "[tensor-files] reload pane={} path={} entries={} dirs={} files={} load={}us reloads={} selected={} selection_changed={}",
            pane.as_str(),
            state.path.display(),
            state.entries.len(),
            dir_count,
    ...
    fn set_view_mode(&mut self, view_mode: ShellViewMode, size: PhysicalSize<u32>) -> bool {
        ...
        self.clamp_scroll(size);
        tensor_files_log!(
            "[tensor-files] view-mode pane={} mode={} switches={} scroll_x={:.1} scroll_y={:.1}",
            pane_id.as_str(),
            view_mode.as_str(),
            self.view_switches,
    ...
    fn set_zoom_level(
        ...
        tensor_files_log!(
            "[tensor-files] zoom pane={} level={} percent={} changes={} scroll_x={:.1} scroll_y={:.1}",
            active_pane.as_str(),
            next_level,
    ...
    fn apply_selection_command(&mut self, command: SelectionCommand) -> bool {
        ...
        if selection_changed || rubber_band_changed {
            tensor_files_log!(
                "[tensor-files] selection command={} selected={} changes={}",
                command.as_str(),
    ...
    fn close_location_draft(&mut self, size: PhysicalSize<u32>) -> bool {
        ...
        self.clamp_scroll(size);
        tensor_files_log!(
            "[tensor-files] location active=0 value=\"\" changes={}",
