...
use crate::{
    ...
    TextFrameResources, ThumbnailSourceKey, ViewRect, decode_file_clipboard_text,
    entry_path_for_thumbnail, folder_preview_gpu_draw_rect, icon_emblem_kinds_for_path,
    icon_emblem_rects, normalized_scale_factor, path_uri_from_path,
