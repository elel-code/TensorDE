...
const OUTPUT_STATE_OVERRIDE: &str = "TENSOR_WALLPAPER_OUTPUT_STATE";
const OUTPUT_STATE_OVERRIDE_FILE: &str = "TENSOR_WALLPAPER_OUTPUT_STATE_FILE";
const DESKTOP_OUTPUTS_OVERRIDE: &str = "TENSOR_WALLPAPER_DESKTOP_OUTPUTS";
const CURSOR_PARALLAX_OVERRIDE: &str = "TENSOR_WALLPAPER_CURSOR_PARALLAX";
