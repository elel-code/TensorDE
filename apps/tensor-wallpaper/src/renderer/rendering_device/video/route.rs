...
pub fn rendering_device_video_duration_playback_frames(
    duration: Duration,
...
pub fn rendering_device_video_playback_frame_count(
...
mod tests {
    ...
    fn duration_uses_the_selected_present_rate() {
        assert_eq!(
            rendering_device_video_duration_playback_frames(Duration::from_secs(10), Some(240)),
            Some(2_400)
        );
    }
    ...
    fn explicit_frame_budget_overrides_duration() {
        assert_eq!(
            rendering_device_video_playback_frame_count(96, Some(2_400)),
            96
        );
    }
    ...
    fn unbounded_duration_still_requests_a_frame() {
        assert_eq!(rendering_device_video_playback_frame_count(0, None), 1);
    }
}
