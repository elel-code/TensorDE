...
pub(in crate::renderer::rendering_device) enum SceneInputAttachmentSource {
    EffectTarget {
        physical_slot: u32,
...
pub(in crate::renderer::rendering_device) struct SceneInputAttachmentBindingPlan {
...
impl SceneInputAttachmentBindingPlan {
    pub(in crate::renderer::rendering_device) fn source(
        &self,
        draw_index: usize,
        input_index: usize,
...
pub(in crate::renderer::rendering_device) fn scene_input_attachment_binding_cycle(
