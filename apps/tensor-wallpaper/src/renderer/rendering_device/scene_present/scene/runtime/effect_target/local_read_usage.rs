...
pub(in crate::renderer::rendering_device) fn apply_scene_effect_target_input_attachment_usage(
...
pub(in crate::renderer::rendering_device) fn apply_scene_effect_target_local_read_candidate_usage(
    plans: &mut [SceneEffectTargetImagePlan],
...
pub(in crate::renderer::rendering_device) fn apply_scene_effect_target_local_read_scope_usage(
    plans: &mut [SceneEffectTargetImagePlan],
    graph: &SceneRenderingDeviceGraphPlan,
