...
pub(in crate::renderer::rendering_device::scene_present::scene::runtime) struct SharedSceneEffectTargetDescriptor
{
    pub(in crate::renderer::rendering_device::scene_present::scene::runtime) physical_slot: u32,
    pub(in crate::renderer::rendering_device::scene_present::scene::runtime) format: TextureFormat,
    pub(in crate::renderer::rendering_device::scene_present::scene::runtime) extent: Extent2D,
    pub(in crate::renderer::rendering_device::scene_present::scene::runtime) input_attachment_required: bool,
}
...
pub(in crate::renderer::rendering_device::scene_present::scene::runtime) struct SharedSceneEffectTargetResource
{
    pub(in crate::renderer::rendering_device::scene_present::scene::runtime) descriptor:
        SharedSceneEffectTargetDescriptor,
    pub(in crate::renderer::rendering_device::scene_present::scene::runtime) image: Image,
    pub(in crate::renderer::rendering_device::scene_present::scene::runtime) view: ImageView,
}

pub(in crate::renderer::rendering_device::scene_present::scene::runtime) struct SharedSceneEffectTargetResources
{
...
impl SharedSceneEffectTargetResources {
        ...
        for descriptor in descriptors.iter().copied() {
            ...
            let image = allocator
                .create_image(&ImageDescriptor {
                    label: Some(format!(
                        "tensor-wallpaper-scene-effect-target-slot-{}",
                        descriptor.physical_slot
                    )),
            ...
            let view = image
                .create_color_view(Some(format!(
                    "tensor-wallpaper-scene-effect-target-view-slot-{}",
                    descriptor.physical_slot
                )))
                .map_err(|error| {
                    format!(
    ...
    pub(in crate::renderer::rendering_device::scene_present::scene::runtime) fn target(
        &self,
        physical_slot: u32,
