...
pub(in crate::renderer::rendering_device) struct SceneCommandOrderFacts {
...
pub(in crate::renderer::rendering_device) fn scene_command_order(
    ...
    let mut order = vec![
        ...
        "create_slang_o2_terminal_present_pipeline",
    ...
    order.extend([
        ...
        "cmd_bind_slang_o2_terminal_present_pipeline",
    ...
    fn command_order_keeps_scene_color_offscreen_until_terminal_present() {
        ...
        assert!(
            position("create_live_physical_offscreen_scene_color_per_frame_slot")
                < position("create_slang_o2_terminal_present_pipeline")
        );
        assert!(
