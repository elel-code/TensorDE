...
use crate::renderer::rendering_device::audio::event_source::{
    RenderingDeviceAudioEventSource, audio_state_summary,
};
use crate::renderer::rendering_device::audio::system_monitor::RenderingDeviceSystemAudioMonitor;
#[cfg(feature = "video")]
use crate::renderer::rendering_device::video::event_source::{
    RenderingDeviceMediaEventSource, RenderingDeviceVideoEventSample,
};
...
pub(super) struct SceneRuntimeEventSources {
    audio_monitor: RenderingDeviceSystemAudioMonitor,
    audio: RenderingDeviceAudioEventSource,
    ...
    #[cfg(feature = "video")]
    media: RenderingDeviceMediaEventSource,
}
...
impl SceneRuntimeEventSources {
    pub(super) fn new(
        ...
        Self {
            audio_monitor: RenderingDeviceSystemAudioMonitor::start_if_needed(audio_spectrum_required),
            audio: RenderingDeviceAudioEventSource::default(),
            ...
            #[cfg(feature = "video")]
            media: RenderingDeviceMediaEventSource::next(),
        }
    }

    pub(super) fn pump_platform(&mut self, host: &mut WaylandHost) -> Result<bool, String> {
    ...
    #[cfg(feature = "video")]
    pub(super) fn publish_video(&mut self, sample: RenderingDeviceVideoEventSample) {
