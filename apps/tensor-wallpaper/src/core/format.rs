...
pub const FORMAT_NAME: &str = "tensor-wallpaper.wallpaper";
pub const FORMAT_VERSION: u32 = 1;
pub const MANIFEST_FILE: &str = "manifest.tensor-wallpaper.json";
pub const MANIFEST_TOML_FILE: &str = "manifest.tensor-wallpaper.toml";
