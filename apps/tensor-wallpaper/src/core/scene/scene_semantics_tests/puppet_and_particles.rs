    ...
    #[test]
    fn waterwaves_effect_stays_gpu_image_space_without_builtin_motion() {
        let document: SceneDocument = serde_json::from_value(json!({
            "resources": [
                {
                    "id": "resource-image",
    ...
    #[test]
    fn waterwave_effect_preserves_parameters_in_image_effect_passes_not_builtin_motion() {
        let document: SceneDocument = serde_json::from_value(json!({
            "resources": [
                {
                    "id": "resource-image",
    ...
    #[test]
    fn foliage_sway_effect_stays_gpu_image_space_without_builtin_motion() {
        let document: SceneDocument = serde_json::from_value(json!({
            "resources": [
                {
                    "id": "resource-image",
    ...
    #[test]
    fn waterwave_effect_keeps_layer_origin_and_skips_builtin_vertex_deformation() {
        let document: SceneDocument = serde_json::from_value(json!({
            "resources": [
                {
                    "id": "resource-image",
                    ...
                    "effects": [
                        {
                            ...
                            "runtime": "builtin-water-caustics",
                            "id": 641,
                            "passes": [
                                {
                                    "constant_shader_values": {
    ...
    #[test]
    fn particle_emitter_expands_to_builtin_rectangle_layers() {
        let document: SceneDocument = serde_json::from_value(json!({
            "nodes": [
                {
                    "id": "spark-emitter",
