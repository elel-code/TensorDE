...
pub struct SceneBinaryDocument {
    ...
    pub texture_sequence_frames: Vec<SceneTextureSequenceFrameRecord>,
    ...
    pub shader_programs: Vec<SceneShaderProgramRecord>,
    pub shader_bindings: Vec<SceneShaderBindingRecord>,
    pub shader_stage_io: Vec<SceneShaderStageIoRecord>,
    pub shader_uniform_buffers: Vec<SceneShaderUniformBufferRecord>,
    pub shader_uniform_members: Vec<SceneShaderUniformMemberRecord>,
    pub shader_spirv: Vec<u32>,
    pub script_programs: Vec<SceneScriptProgramRecord>,
    pub dynamic_texts: Vec<SceneDynamicTextRecord>,
    pub dynamic_text_glyphs: Vec<SceneDynamicTextGlyphRecord>,
    pub user_property_bindings: Vec<SceneUserPropertyBindingRecord>,
...
impl Default for SceneBinaryDocument {
    fn default() -> Self {
        Self {
            ...
            texture_sequence_frames: Vec::new(),
            ...
            shader_stage_io: Vec::new(),
            shader_uniform_buffers: Vec::new(),
            shader_uniform_members: Vec::new(),
