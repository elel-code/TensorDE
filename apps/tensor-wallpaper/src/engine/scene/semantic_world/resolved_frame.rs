...
pub struct ResolvedSemanticFrame {
    ...
    /// Retained WE camera-parallax displacement consumed by particle billboard projection.
    /// Regular objects receive only their topmost-root `parallaxDepth` render-world translation.
    pub particle_camera_parallax_translation: [f32; 2],
