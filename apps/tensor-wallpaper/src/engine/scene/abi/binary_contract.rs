...
pub const SCENE_BINARY_VERSION: u32 = 48;
...
pub const CHUNK_SHADER_PROGRAM: u32 = u32::from_le_bytes(*b"SPRV");
pub const CHUNK_DYNAMIC_TEXT: u32 = u32::from_le_bytes(*b"DTXT");
...
pub const INVALID_PARTICLE_INDEX: u32 = u32::MAX;
