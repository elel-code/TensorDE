...
const UV_TARGET_NAME: &str = "_tensor_wallpaper_waterwaves_uv_field";
const GROUP_COLOR_TARGET_NAME: &str = "_tensor_wallpaper_puppet_group_color";
...
mod tests {
    ...
    fn authored_puppet_chain_rejects_uv_field_aggregation() {
        ...
        assert_eq!(
            ...
            RenderPassEffectVisibility::any_visible(5, 1)
        );
        assert_eq!(
            graph.passes[4].effect_visibility,
            RenderPassEffectVisibility::none_visible(5, 1)
        );
    }
