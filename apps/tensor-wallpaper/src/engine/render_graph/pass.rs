...
impl RenderPassEffectVisibility {
    ...
    pub const fn any_visible(binding_start: u32, binding_count: u32) -> Self {
        Self {
            binding_start,
            binding_count,
            policy: RenderPassEffectVisibilityPolicy::AnyVisible,
        }
    }

    pub const fn none_visible(binding_start: u32, binding_count: u32) -> Self {
        Self {
            binding_start,
            binding_count,
            policy: RenderPassEffectVisibilityPolicy::NoneVisible,
        }
    }
}
