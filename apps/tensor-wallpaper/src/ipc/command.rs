...
pub fn help_text() -> String {
    [
        "usage:",
        "  tensor-wallpaperctl ping",
        "  tensor-wallpaperctl status",
        "  tensor-wallpaperctl status --decisions-csv [--from-file <status.json>]",
        "  tensor-wallpaperctl status --telemetry-csv [--from-file <status.json>]",
        "  tensor-wallpaperctl outputs",
        "  tensor-wallpaperctl watch",
        "  tensor-wallpaperctl properties get [key] [--output <name>]",
        "  tensor-wallpaperctl properties set <key> <value-json> [--output <name>]",
        "  tensor-wallpaperctl properties unset <key> [--output <name>]",
        "  tensor-wallpaperctl set <wallpaper.gwp|wallpaper.gwpdir> [--output <name>] [--variant <id>]",
        "  tensor-wallpaperctl pause [--output <name>]",
        "  tensor-wallpaperctl resume [--output <name>]",
        "  tensor-wallpaperctl stop [--output <name>]",
    ]
    .join("\n")
}
