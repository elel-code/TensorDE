...
Examples use canonical `manifest.tensor-wallpaper.json`. Hand-written `.gwpdir` packages
may use `manifest.tensor-wallpaper.toml`; packing normalizes them back to JSON.
