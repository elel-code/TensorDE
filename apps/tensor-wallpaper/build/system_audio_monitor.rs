...
pub(super) fn build_system_audio_monitor() {
    ...
    let archive = out_dir.join("libtensor_wallpaper_system_audio_monitor.a");
    let source =
        PathBuf::from("src/renderer/rendering_device/audio/system_monitor/pipewire_monitor.c");
    ...
    println!("cargo:rustc-link-lib=static=tensor_wallpaper_system_audio_monitor");
