...
//!
//! Authored sampling reference: `reverse-engineered/tensor-wallpaper/shaders/effects/waterwaves.frag`.
...
fn waterwaves_direct_fragment(
    ...
    // coincide, so one center sample is the authored identity. Mesh and
    ...
    let source_filter = if static_black_output {
        ...
        // gate with the center sample; retain implicit mip and anisotropy state.
