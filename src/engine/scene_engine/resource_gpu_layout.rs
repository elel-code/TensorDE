...
pub const SCENE_GPU_LAYER_ALPHA_MASK_RT_METHOD8_MDLV_INDEX_BYTES: u64 = 2;
...
pub const SCENE_GPU_PUPPET_CLIPPING_RECORD_BYTES: u64 = 48;
pub const SCENE_GPU_PUPPET_CLIPPING_BONE_INDEX_BYTES: u64 = 4;
pub const SCENE_GPU_PUPPET_CLIPPING_FRAME_KEY_BYTES: u64 = 4;
pub const SCENE_GPU_PUPPET_ACTIVE_SOURCE_BYTES: u64 = 64;
pub const SCENE_GPU_GENERICIMAGE4_MATERIAL_UNIFORM_BYTES: u64 = WE_VEC4_BYTES * 3;
pub const SCENE_GPU_IRIS_EFFECT_VERTEX_UNIFORM_BYTES: u64 = WE_VEC4_BYTES * 3;
pub const SCENE_GPU_IRIS_EFFECT_FRAGMENT_UNIFORM_BYTES: u64 = WE_VEC4_BYTES;
pub const SCENE_GPU_IRIS_EFFECT_UNIFORM_BYTES: u64 =
    SCENE_GPU_IRIS_EFFECT_VERTEX_UNIFORM_BYTES + SCENE_GPU_IRIS_EFFECT_FRAGMENT_UNIFORM_BYTES;
