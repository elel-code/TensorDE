...
"#,
    ...
    fn converts_scene_project_to_native_scene_document() {
        ...
        assert_eq!(full_scene.progress_estimate_percent, 97);
        assert!(
            full_scene
