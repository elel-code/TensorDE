...
use super::components::{
    Focused, StackingOrder, View, ViewContent, ViewEffects, ViewGeometry, ViewLayout,
    ViewPlacement, Workspace,
};
    ...
    pub fn arrange_workspace(
        ...
        for _ in 0..pending.len() {
            ...
            for view in pending {
                ...
                geometries.insert(
                    view.id,
                    attached_geometry(owner_geometry, view.layout.constraints, preferred_size),
                );
                progressed = true;
            }
