...
impl NativeVulkanH264PictureFieldKind {
    ...
    pub(super) fn from_slice(slice: &NativeVulkanH264AccessUnitSliceSnapshot) -> Self {
        Self::from_flags(slice.field_pic_flag, slice.bottom_field_flag)
    }

    pub(super) fn field_pic_flag(self) -> bool {
        !matches!(self, Self::Frame)
    }

    pub(super) fn bottom_field_flag(self) -> bool {
        matches!(self, Self::BottomField)
    }

    pub(super) fn opposite_field(self) -> Self {
        match self {
...
pub(super) struct NativeVulkanH264DpbReferenceState {
    ...
    pub(super) dpb_slot: u32,
    pub(super) pic_order_cnt_val: i32,
    pub(super) pic_order_cnt: [i32; 2],
    pub(super) frame_num: u16,
    pub(super) field_kind: NativeVulkanH264PictureFieldKind,
...
pub(super) struct NativeVulkanH264InferredNonExistingPlan {
    ...
    pub(super) references: Vec<NativeVulkanH264InferredNonExistingReferenceSnapshot>,
    pub(super) dropped_short_term_frame_nums: Vec<u16>,
    pub(super) dropped_long_term_frame_indices: Vec<u16>,
...
pub(super) struct NativeVulkanH264AdaptiveMarkingPlan {
    ...
    pub(super) drop_long_term_keys: Vec<NativeVulkanH264LongTermPictureKey>,
    pub(super) convert_short_term_to_long_term: Vec<(NativeVulkanH264ShortTermPictureKey, u16)>,
...
pub(super) struct NativeVulkanAv1ReferenceMapEntry {
    pub(super) slot: u32,
    pub(super) order_hint: Option<u8>,
    pub(super) frame_type: u8,
    pub(super) frame_width: Option<u32>,
    pub(super) frame_height: Option<u32>,
    pub(super) render_width: Option<u32>,
...
impl NativeVulkanAv1DecodeReferencePlanner {
    ...
    pub(super) fn map_slot_indices(&self) -> Vec<i32> {
        self.reference_map
            .iter()
    ...
    pub(super) fn map_order_hints(&self) -> Vec<Option<u8>> {
        self.reference_map
            .iter()
    ...
    pub(super) fn reference_name_order_hints(&self, ref_frame_indices: &[i8]) -> Vec<Option<u8>> {
    ...
    pub(super) fn allocate_output_slot(&mut self, protected_slots: &[u32]) -> Option<u32> {
...
pub(super) struct NativeVulkanH264DecodeReferencePlanner {
    pub(super) dpb_slots: u32,
    pub(super) max_short_term_references: u32,
    pub(super) max_frame_num: u32,
    pub(super) gaps_in_frame_num_allowed: bool,
    pub(super) previous_reference_frame_num: Option<u16>,
    pub(super) short_term_references:
        BTreeMap<NativeVulkanH264ShortTermPictureKey, NativeVulkanH264DpbReferenceState>,
    pub(super) long_term_references:
        BTreeMap<NativeVulkanH264LongTermPictureKey, NativeVulkanH264DpbReferenceState>,
    pub(super) slot_to_reference_key: Vec<Option<NativeVulkanH264DpbSlotKey>>,
    pub(super) short_term_reference_order: Vec<NativeVulkanH264ShortTermPictureKey>,
    pub(super) next_output_slot: u32,
}
...
impl NativeVulkanH264DecodeReferencePlanner {
    ...
    pub(super) fn choose_output_slot(&mut self) -> u32 {
        for offset in 0..self.dpb_slots {
            let slot = (self.next_output_slot + offset) % self.dpb_slots;
            if self
    ...
    pub(super) fn active_reference_count(&self) -> usize {
        self.short_term_references
            .len()
            .saturating_add(self.long_term_references.len())
    }

    pub(super) fn enforce_sliding_reference_window(&mut self) -> Vec<(u16, u32)> {
    ...
    pub(super) fn infer_non_existing_short_term_references(
        &mut self,
        current_frame_num: u16,
    ...
    pub(super) fn record_inference_dropped_key(
        &mut self,
    ...
    pub(super) fn clear_slot_for_inference(
        &mut self,
        slot: u32,
        plan: &mut NativeVulkanH264InferredNonExistingPlan,
    ) {
    ...
    pub(super) fn remove_short_term_reference(
        &mut self,
        key: NativeVulkanH264ShortTermPictureKey,
    ) -> Option<u32> {
        self.short_term_reference_order
    ...
    pub(super) fn remove_long_term_reference(
        &mut self,
    ...
    pub(super) fn clear_slot(&mut self, slot: u32) {
        let key = self
            .slot_to_reference_key
            .get(slot as usize)
            .copied()
    ...
    pub(super) fn convert_short_term_to_long_term(
        &mut self,
        key: NativeVulkanH264ShortTermPictureKey,
        long_term_frame_idx: u16,
...
pub(super) struct NativeVulkanH265DecodeReferencePlanner {
    ...
    pub(super) poc_to_decoded_slot: BTreeMap<i32, (u32, u32)>,
    pub(super) slot_to_poc: Vec<Option<i32>>,
    pub(super) next_output_slot: u32,
    pub(super) prev_poc_lsb: Option<i32>,
...
impl NativeVulkanH265DecodeReferencePlanner {
    ...
    pub(super) fn reset_for_idr(&mut self) {
    ...
    pub(super) fn choose_output_slot(&mut self, protected_pocs: &[i32]) -> u32 {
        for offset in 0..self.dpb_slots {
            let slot = (self.next_output_slot + offset) % self.dpb_slots;
            if self
                .slot_to_poc
    ...
    pub(super) fn derive_current_poc(
        &mut self,
    ...
    pub(super) fn derive_long_term_reference_poc(
        &self,
        slice: &NativeVulkanH265AccessUnitSliceSnapshot,
        current_poc: i32,
