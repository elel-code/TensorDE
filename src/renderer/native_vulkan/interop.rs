...
pub fn video_interop_contract() -> NativeVulkanVideoInteropContract {
    NativeVulkanVideoInteropContract {
        ...
        vulkanalia_replacement_policy: "keep vulkanalia as the owning native-vulkan-renderer surface for instance/device ownership, Vulkan Video submit helpers, image/import resources and present telemetry",
