...
pub(in crate::renderer::native_vulkan::vulkan) struct VulkanaliaDecodedImagePresentSamplerResources
{
    pub(in crate::renderer::native_vulkan::vulkan) descriptor_heap:
        VulkanaliaDescriptorHeapImageSamplerResources,
...
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_retarget_decoded_image_present_sampler_layer(
    _device: &Device,
    resource_image: &VulkanaliaVideoSessionResourceImage,
...
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_destroy_decoded_image_present_sampler_resources(
    device: &Device,
