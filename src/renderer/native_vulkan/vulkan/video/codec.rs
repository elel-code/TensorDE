...
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_video_session_codec_name(
...
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_video_session_label(
    codec: NativeVulkanVideoSessionCodec,
) -> &'static str {
    codec.label()
}

pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_video_session_profile_label(
    codec: NativeVulkanVideoSessionCodec,
) -> &'static str {
    codec.profile_label()
}

pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_video_session_format_probe_profile(
    codec: NativeVulkanVideoSessionCodec,
) -> &'static str {
    match codec {
...
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_video_session_bit_depth(
    codec: NativeVulkanVideoSessionCodec,
...
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_video_session_picture_format(
    codec: NativeVulkanVideoSessionCodec,
) -> vk::Format {
    match codec {
        NativeVulkanVideoSessionCodec::H264High8
...
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_video_session_codec_operation(
    codec: NativeVulkanVideoSessionCodec,
...
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_video_decode_codec_label(
    codec: NativeVulkanVideoSessionCodec,
) -> &'static str {
    match codec {
