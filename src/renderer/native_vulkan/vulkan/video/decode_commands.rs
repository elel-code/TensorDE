...
pub(in crate::renderer::native_vulkan::vulkan) struct NativeVulkanVulkanaliaDecodePrepareBarrierPlan
{
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize)]
pub(in crate::renderer::native_vulkan::vulkan) struct NativeVulkanVulkanaliaDecodeCommandBodyPlan {
    pub ffmpeg_reference: &'static str,
    pub command_order: &'static [&'static str],
}

#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize)]
pub(in crate::renderer::native_vulkan::vulkan) struct NativeVulkanVulkanaliaDecodeCommandBufferPlan
{
    pub ffmpeg_reference: &'static str,
    pub uses_synchronization2: bool,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize)]
pub(in crate::renderer::native_vulkan::vulkan) struct NativeVulkanVulkanaliaDecodeSubmit2Plan {
    pub ffmpeg_reference: &'static str,
...
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_decode_prepare_barrier_plan(
...
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_decode_command_body_plan(
...
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_decode_command_buffer_plan(
...
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_decode_submit2_plan(
...
pub(in crate::renderer::native_vulkan::vulkan) unsafe fn native_vulkan_vulkanalia_record_decode_prepare_barriers(
    device: &Device,
...
pub(in crate::renderer::native_vulkan::vulkan) unsafe fn native_vulkan_vulkanalia_record_h265_decode_commands(
    device: &Device,
    command_buffer: vk::CommandBuffer,
...
pub(in crate::renderer::native_vulkan::vulkan) unsafe fn native_vulkan_vulkanalia_record_av1_decode_commands(
    device: &Device,
    command_buffer: vk::CommandBuffer,
...
pub(in crate::renderer::native_vulkan::vulkan) unsafe fn native_vulkan_vulkanalia_record_h264_decode_commands(
    device: &Device,
    command_buffer: vk::CommandBuffer,
...
pub(in crate::renderer::native_vulkan::vulkan) unsafe fn native_vulkan_vulkanalia_record_av1_decode_command_buffer(
    device: &Device,
    command_buffer: vk::CommandBuffer,
    image: vk::Image,
    plan: &NativeVulkanVulkanaliaAv1DecodeSubmitPlan,
...
pub(in crate::renderer::native_vulkan::vulkan) unsafe fn native_vulkan_vulkanalia_record_h265_decode_command_buffer(
    device: &Device,
    command_buffer: vk::CommandBuffer,
    image: vk::Image,
    plan: &NativeVulkanVulkanaliaH265DecodeSubmitPlan,
...
pub(in crate::renderer::native_vulkan::vulkan) unsafe fn native_vulkan_vulkanalia_record_h264_decode_command_buffer(
    device: &Device,
    command_buffer: vk::CommandBuffer,
    image: vk::Image,
    plan: &NativeVulkanVulkanaliaH264DecodeSubmitPlan,
...
pub(in crate::renderer::native_vulkan::vulkan) unsafe fn native_vulkan_vulkanalia_submit_decode_command_buffer2(
    device: &Device,
    queue: vk::Queue,
    command_buffer: vk::CommandBuffer,
    fence: vk::Fence,
