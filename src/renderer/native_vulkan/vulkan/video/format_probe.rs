...
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_video_format_probe(
    instance: &Instance,
...
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_video_format_properties_for_profile(
    instance: &Instance,
    physical_device: vk::PhysicalDevice,
    profile_info: &vk::VideoProfileInfoKHR,
    image_usage: vk::ImageUsageFlags,
