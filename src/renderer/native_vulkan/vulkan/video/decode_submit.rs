...
pub(in crate::renderer::native_vulkan::vulkan) const FFMPEG_VULKAN_DECODE_REFERENCE: &str =
    "references/ffmpeg/libavcodec/vulkan_decode.c";
pub(in crate::renderer::native_vulkan::vulkan) const FFMPEG_VULKAN_DECODE_PICTURE_REFERENCE: &str =
    "references/ffmpeg/libavcodec/vulkan_decode.h:88-93";
pub(in crate::renderer::native_vulkan::vulkan) const FFMPEG_VULKAN_DECODE_BEGIN_CURRENT_REFERENCE: &str =
...
pub(in crate::renderer::native_vulkan::vulkan) const NATIVE_VULKAN_VULKANALIA_MAX_DECODE_REFERENCE_SLOTS: usize = 36;
pub(in crate::renderer::native_vulkan::vulkan) const NATIVE_VULKAN_VULKANALIA_MAX_BEGIN_REFERENCE_SLOTS: usize =
...
pub(in crate::renderer::native_vulkan::vulkan) struct NativeVulkanVulkanaliaPictureResourcePlan {
...
impl NativeVulkanVulkanaliaPictureResourcePlan {
    ...
    pub(in crate::renderer::native_vulkan::vulkan) fn to_vk(
        &self,
    ...
    pub(in crate::renderer::native_vulkan::vulkan) fn to_vk_with_base_array_layer(
        &self,
        image_view_binding: vk::ImageView,
        base_array_layer: u32,
    ) -> vk::VideoPictureResourceInfoKHR {
    ...
    pub(in crate::renderer::native_vulkan::vulkan) fn with_base_array_layer(
        &self,
        base_array_layer: u32,
    ) -> Self {
        Self {
...
pub(in crate::renderer::native_vulkan::vulkan) struct NativeVulkanVulkanaliaDecodeImageViewBindings
{
...
impl NativeVulkanVulkanaliaDecodeImageViewBindings {
    #[cfg(test)]
    pub(in crate::renderer::native_vulkan::vulkan) fn repeated(
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize)]
pub(in crate::renderer::native_vulkan::vulkan) struct NativeVulkanVulkanaliaReferenceSlotPlan {
    pub slot_index: i32,
    pub resource: NativeVulkanVulkanaliaPictureResourcePlan,
}

impl NativeVulkanVulkanaliaReferenceSlotPlan {
    pub(in crate::renderer::native_vulkan::vulkan) fn setup_current(
        slot_index: i32,
...
pub(in crate::renderer::native_vulkan::vulkan) struct NativeVulkanVulkanaliaDecodeSubmitPlan {
...
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_decode_command_order(
    reset_control_recorded: bool,
) -> &'static [&'static str] {
