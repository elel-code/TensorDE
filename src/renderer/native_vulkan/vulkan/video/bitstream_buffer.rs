...
pub(in crate::renderer::native_vulkan::vulkan) struct VulkanaliaVideoSessionBitstreamBuffer {
    pub(in crate::renderer::native_vulkan::vulkan) buffer: vk::Buffer,
    pub(in crate::renderer::native_vulkan::vulkan) memory: vk::DeviceMemory,
    pub(in crate::renderer::native_vulkan::vulkan) mapped_ptr: Option<*mut std::ffi::c_void>,
    pub(in crate::renderer::native_vulkan::vulkan) snapshot:
        NativeVulkanVulkanaliaVideoSessionBitstreamBufferSnapshot,
}

pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_smoke_create_video_session_bitstream_buffer(
    device: &Device,
...
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_create_video_session_bitstream_buffer(
    device: &Device,
    memory_properties: &vk::PhysicalDeviceMemoryProperties,
    profile_info: &vk::VideoProfileInfoKHR,
    requested_size: u64,
...
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_destroy_video_session_bitstream_buffer(
    device: &Device,
...
pub(crate) fn native_vulkan_vulkanalia_ffmpeg_decode_bitstream_buffer_size(
    payload_len: u64,
    min_size_alignment: u64,
) -> u64 {
...
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_write_ffmpeg_picture_slices_buffer(
    device: &Device,
    buffer: &VulkanaliaVideoSessionBitstreamBuffer,
    payload: &[u8],
    min_size_alignment: u64,
