...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub(in crate::renderer::native_vulkan::vulkan) struct NativeVulkanVulkanaliaAv1PictureInfoPlan<'a> {
    pub ffmpeg_reference: &'static str,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub(in crate::renderer::native_vulkan::vulkan) struct NativeVulkanVulkanaliaAv1DecodeSubmitPlan<'a>
{
...
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_av1_decode_submit_plan<
    'a,
>(
    extent: vk::Extent2D,
...
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_av1_with_vk_submit_info<
    R,
>(
