...
pub(in crate::renderer::native_vulkan::vulkan) struct NativeVulkanVulkanaliaVideoSessionMemoryBindingResources
{
...
-> NativeVulkanVulkanaliaVideoSessionTemplate {
    NativeVulkanVulkanaliaVideoSessionTemplate {
        ...
        vulkanalia_target_module: "src/renderer/native_vulkan/vulkan/video/session.rs",
        ...
        resource_steps: vec![
            NativeVulkanVulkanaliaVideoSessionResourceStep {
                ...
                source_boundary: "Vulkan Video profile and format query",
            ...
            NativeVulkanVulkanaliaVideoSessionResourceStep {
                ...
                source_boundary: "VkVideoSessionKHR creation",
            ...
            NativeVulkanVulkanaliaVideoSessionResourceStep {
                ...
                source_boundary: "video-session memory requirements and bind",
            ...
            NativeVulkanVulkanaliaVideoSessionResourceStep {
                ...
                source_boundary: "DPB/output image allocation",
            ...
            NativeVulkanVulkanaliaVideoSessionResourceStep {
                ...
                source_boundary: "codec-specific session parameters",
            ...
            NativeVulkanVulkanaliaVideoSessionResourceStep {
                ...
                source_boundary: "mapped bitstream upload buffer",
            ...
            NativeVulkanVulkanaliaVideoSessionResourceStep {
                ...
                source_boundary: "codec-specific decode submit",
...
#[allow(dead_code)]
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_create_video_session(
    device: &Device,
...
#[allow(dead_code)]
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_video_session_memory_requirements(
    device: &Device,
...
#[allow(dead_code)]
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_bind_video_session_memory(
    device: &Device,
    session: vk::VideoSessionKHR,
...
#[allow(dead_code)]
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_destroy_video_session(
    device: &Device,
    session: vk::VideoSessionKHR,
) {
    unsafe {
...
#[allow(dead_code)]
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_smoke_bind_video_session_memory(
    device: &Device,
...
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_bind_video_session_memory_resources(
    device: &Device,
    memory_properties: &vk::PhysicalDeviceMemoryProperties,
    session: vk::VideoSessionKHR,
...
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_destroy_video_session_memory_binding_resources(
    device: &Device,
