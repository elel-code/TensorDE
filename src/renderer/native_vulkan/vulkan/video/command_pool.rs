...
pub(in crate::renderer::native_vulkan::vulkan) struct NativeVulkanVulkanaliaDecodeCommandBufferSnapshot
{
...
pub(in crate::renderer::native_vulkan::vulkan) struct VulkanaliaDecodeCommandBuffer {
    pub(in crate::renderer::native_vulkan::vulkan) command_pool: vk::CommandPool,
    pub(in crate::renderer::native_vulkan::vulkan) command_buffers: Vec<vk::CommandBuffer>,
    pub(in crate::renderer::native_vulkan::vulkan) submit_fences: Vec<vk::Fence>,
    pub(in crate::renderer::native_vulkan::vulkan) snapshot:
        NativeVulkanVulkanaliaDecodeCommandBufferSnapshot,
}

impl VulkanaliaDecodeCommandBuffer {
    pub(in crate::renderer::native_vulkan::vulkan) fn command_buffer_at(
        &self,
        frame_index: usize,
    ...
    pub(in crate::renderer::native_vulkan::vulkan) fn submit_fence_at(
        &self,
        frame_index: usize,
    ) -> Result<vk::Fence, String> {
...
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_create_decode_command_buffers(
    device: &Device,
...
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_destroy_decode_command_buffer(
    device: &Device,
