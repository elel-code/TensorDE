...
pub(in crate::renderer::native_vulkan::vulkan) struct NativeVulkanVulkanaliaH265ParameterIds {
...
pub(in crate::renderer::native_vulkan::vulkan) struct NativeVulkanVulkanaliaH265ReferenceInfoPlan {
    pub slot_index: i32,
    pub delta_poc: i32,
    pub poc: i32,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub(in crate::renderer::native_vulkan::vulkan) struct NativeVulkanVulkanaliaH265PictureInfoPlan<'a>
{
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub(in crate::renderer::native_vulkan::vulkan) struct NativeVulkanVulkanaliaH265DecodeSubmitPlan<'a>
{
    pub common: NativeVulkanVulkanaliaDecodeSubmitPlan,
    pub picture: NativeVulkanVulkanaliaH265PictureInfoPlan<'a>,
}

pub(in crate::renderer::native_vulkan::vulkan) struct NativeVulkanVulkanaliaH265VkSubmitInfo<'a> {
    pub begin_info: &'a vk::VideoBeginCodingInfoKHR,
    pub decode_info: &'a vk::VideoDecodeInfoKHR,
    pub inline_session_parameters_info: &'a vk::VideoDecodeH265InlineSessionParametersInfoKHR,
...
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_h265_ready_prefix_decode_submit_plan<
    'a,
>(
    extent: vk::Extent2D,
...
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_h265_with_vk_submit_info<
    R,
>(
    plan: &NativeVulkanVulkanaliaH265DecodeSubmitPlan<'_>,
    video_session: vk::VideoSessionKHR,
    mut inline_session_parameters_info: vk::VideoDecodeH265InlineSessionParametersInfoKHR,
...
mod tests {
    ...
    fn h265_ready_prefix_plan_lowers_to_vulkanalia_decode_info() {
        ...
        native_vulkan_vulkanalia_h265_with_vk_submit_info(
            ...
            vk::VideoDecodeH265InlineSessionParametersInfoKHR::builder().build(),
            vk::Buffer::default(),
            &image_views,
            |vk_info| {
                assert_eq!(
