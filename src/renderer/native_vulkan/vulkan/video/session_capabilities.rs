...
pub(in crate::renderer::native_vulkan::vulkan) struct VulkanaliaVideoSessionCapabilityQuery {
    pub(in crate::renderer::native_vulkan::vulkan) capabilities: vk::VideoCapabilitiesKHR,
    pub(in crate::renderer::native_vulkan::vulkan) decode_capability_flags:
        vk::VideoDecodeCapabilityFlagsKHR,
    pub(in crate::renderer::native_vulkan::vulkan) codec_max_level: Option<&'static str>,
    pub(in crate::renderer::native_vulkan::vulkan) codec_max_level_raw: Option<i32>,
}

pub(in crate::renderer::native_vulkan::vulkan) fn with_native_vulkan_vulkanalia_video_session_capabilities<
    R,
>(
    instance: &Instance,
...
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_video_session_effective_profile_label(
    codec: NativeVulkanVideoSessionCodec,
    h264_parameter_sets: Option<&NativeVulkanH264ParameterSetSnapshot>,
    av1_sequence_header: Option<&NativeVulkanAv1SequenceHeaderSnapshot>,
...
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_video_session_effective_format_probe_profile(
    codec: NativeVulkanVideoSessionCodec,
    h264_parameter_sets: Option<&NativeVulkanH264ParameterSetSnapshot>,
    av1_sequence_header: Option<&NativeVulkanAv1SequenceHeaderSnapshot>,
) -> Result<&'static str, String> {
...
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_video_session_effective_bit_depth(
    codec: NativeVulkanVideoSessionCodec,
    av1_sequence_header: Option<&NativeVulkanAv1SequenceHeaderSnapshot>,
...
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_video_session_effective_picture_format(
    codec: NativeVulkanVideoSessionCodec,
    av1_sequence_header: Option<&NativeVulkanAv1SequenceHeaderSnapshot>,
) -> vk::Format {
    if matches!(
...
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_video_format_probe_includes_format(
...
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_video_session_extent_supported(
    extent: vk::Extent2D,
...
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_video_session_max_dpb_slots(
...
pub(in crate::renderer::native_vulkan::vulkan) fn native_vulkan_vulkanalia_video_session_max_active_reference_pictures(
