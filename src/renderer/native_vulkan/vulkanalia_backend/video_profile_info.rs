...
pub(super) fn with_vulkanalia_h264_video_profile_info<R>(
...
pub(super) fn with_vulkanalia_h265_video_profile_info<R>(
...
pub(super) fn with_vulkanalia_av1_video_profile_info<R>(
    bit_depth: vk::VideoComponentBitDepthFlagsKHR,
