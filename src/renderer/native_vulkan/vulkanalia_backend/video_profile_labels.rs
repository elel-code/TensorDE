...
pub(super) fn video_chroma_subsampling_labels(
...
pub(super) fn video_component_bit_depth_labels(
...
pub(super) fn video_capability_flag_labels(
...
pub(super) fn video_decode_capability_flag_labels(
...
pub(super) fn h264_picture_layout_label(
...
pub(super) fn h264_level_label(level: vk::video::StdVideoH264LevelIdc) -> Option<&'static str> {
    [
...
pub(super) fn h265_level_label(level: vk::video::StdVideoH265LevelIdc) -> Option<&'static str> {
    [
...
pub(super) fn av1_level_label(level: vk::video::StdVideoAV1Level) -> Option<&'static str> {
    [
