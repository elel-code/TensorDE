...
pub(super) const DESCRIPTOR_HEAP_EXTENSION_NAME: &str = "VK_EXT_descriptor_heap";
...
pub(super) fn native_vulkan_vulkanalia_core_feature_snapshot(
    instance: &Instance,
...
impl NativeVulkanVulkanaliaCoreFeatureSnapshot {
    ...
    pub(super) fn enables_descriptor_heap_features(self) -> bool {
...
pub(super) fn native_vulkan_vulkanalia_descriptor_heap_device_features(
    core_features: NativeVulkanVulkanaliaCoreFeatureSnapshot,
