...
pub(super) fn native_vulkan_vulkanalia_smoke_create_h264_video_session_parameters(
    device: &Device,
...
pub(super) fn native_vulkan_vulkanalia_h264_std_profile_idc(
    profile_idc: u8,
...
pub(super) fn native_vulkan_vulkanalia_h264_std_profile_label(
    profile_idc: u8,
) -> Result<&'static str, String> {
    match profile_idc {
        66 => Ok("baseline"),
