...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(super) struct VulkanaliaSceneLiteSampledImageDrawCommand {
    pub(super) layer_index: usize,
    pub(super) descriptor_binding: VulkanaliaSceneLiteSampledImageDescriptorBinding,
    pub(super) first_index: u32,
    pub(super) index_count: u32,
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(super) struct VulkanaliaSceneLiteSolidQuadDrawCommand {
    pub(super) layer_index: usize,
    pub(super) first_index: u32,
    pub(super) index_count: u32,
}
...
pub(super) struct VulkanaliaSceneLiteSolidQuadDrawResources<'a> {
    ...
    pub(super) draw_commands: &'a [VulkanaliaSceneLiteSolidQuadDrawCommand],
}
...
pub(super) fn native_vulkan_vulkanalia_create_scene_lite_sampled_image_pipeline_resources(
    device: &Device,
    target_format: vk::Format,
    extent: vk::Extent2D,
...
pub(super) fn native_vulkan_vulkanalia_destroy_scene_lite_sampled_image_pipeline_resources(
    device: &Device,
...
#[allow(clippy::too_many_arguments)]
pub(super) fn native_vulkan_vulkanalia_record_scene_lite_sampled_image_command_buffer(
    device: &Device,
    command_buffer: vk::CommandBuffer,
    swapchain_image: vk::Image,
    swapchain_view: vk::ImageView,
