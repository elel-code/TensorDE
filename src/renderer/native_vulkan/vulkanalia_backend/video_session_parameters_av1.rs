...
pub(super) fn native_vulkan_vulkanalia_smoke_create_av1_video_session_parameters(
    device: &Device,
...
pub(super) fn native_vulkan_vulkanalia_av1_sequence_header_codec_label(
    sequence_header: &NativeVulkanAv1SequenceHeaderSnapshot,
) -> &'static str {
...
pub(super) fn native_vulkan_vulkanalia_av1_sequence_header_profile_label(
    sequence_header: &NativeVulkanAv1SequenceHeaderSnapshot,
) -> &'static str {
    match sequence_header.color_config.bit_depth {
        10 => "main-10",
...
pub(super) fn native_vulkan_vulkanalia_av1_sequence_header_bit_depth(
    sequence_header: &NativeVulkanAv1SequenceHeaderSnapshot,
) -> u8 {
