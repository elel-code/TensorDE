...
pub(super) struct VulkanaliaDescriptorHeapBuffer {
    buffer: vk::Buffer,
...
pub(super) struct VulkanaliaDescriptorHeapImageSamplerResources {
    ...
    pub(super) plan: NativeVulkanVulkanaliaDescriptorHeapImageSamplerPlanSnapshot,
    pub(super) snapshot: NativeVulkanVulkanaliaDescriptorHeapImageSamplerResourceSnapshot,
}

pub(super) fn native_vulkan_vulkanalia_descriptor_heap_image_sampler_plan(
...
pub(super) fn native_vulkan_vulkanalia_create_descriptor_heap_image_sampler_resources(
    device: &Device,
...
pub(super) fn native_vulkan_vulkanalia_write_descriptor_heap_image_sampler(
    device: &Device,
...
pub(super) fn native_vulkan_vulkanalia_descriptor_heap_combined_image_sampler_mapping(
    plan: &NativeVulkanVulkanaliaDescriptorHeapImageSamplerPlanSnapshot,
    image_index: usize,
...
pub(super) fn native_vulkan_vulkanalia_descriptor_heap_sampler_bind_info(
    resources: &VulkanaliaDescriptorHeapImageSamplerResources,
) -> vk::BindHeapInfoEXT {
    vk::BindHeapInfoEXT::builder()
        .heap_range(
...
pub(super) fn native_vulkan_vulkanalia_destroy_descriptor_heap_image_sampler_resources(
    device: &Device,
    resources: VulkanaliaDescriptorHeapImageSamplerResources,
) {
