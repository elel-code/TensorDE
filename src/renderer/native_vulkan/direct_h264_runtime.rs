...
use super::{NativeVulkanAudioClockRuntimeSnapshot, NativeVulkanH264DecodedFrameReferenceSnapshot};

#[derive(Debug, Clone, PartialEq, Serialize)]
pub struct NativeVulkanDirectH264ReadyPrefixRuntimeSnapshot {
    ...
    pub h264_present_result_wait_elapsed_us: u64,
    pub h264_present_result_wait_max_us: u64,
    pub h264_acquire_not_ready_count: u32,
    pub h264_acquire_wait_present_result_count: u32,
    pub h264_acquire_wait_present_result_elapsed_us: u64,
    pub h264_acquire_wait_present_result_max_us: u64,
    pub h264_display_ring_slot_count: u32,
    pub h264_display_ring_memory_bytes: u64,
    pub h264_display_copy_count: u32,
    pub h264_display_copy_record_elapsed_us: u64,
    pub h264_display_copy_submit_elapsed_us: u64,
    ...
    pub h264_packet_queue_loop_skipped_access_units: u32,
    ...
    pub h264_decode_ahead_strategy: &'static str,
    pub h264_decode_ahead_attempt_count: u32,
    pub h264_decode_ahead_submit_count: u32,
    pub h264_decode_ahead_skip_unready_count: u32,
    pub h264_decode_ahead_skip_output_hazard_count: u32,
    pub h264_decode_ahead_skip_reference_hazard_count: u32,
    pub h264_decode_ahead_skip_bitstream_overlap_count: u32,
    pub h264_decode_ahead_copy_wait_output_hazard_count: u32,
...
pub struct NativeVulkanDirectH264ReadyPrefixFrameSnapshot {
    ...
    pub display_slot: Option<u32>,
    pub display_slot_wait_elapsed_us: u64,
    pub display_copy_record_elapsed_us: u64,
    pub display_copy_submit_elapsed_us: u64,
