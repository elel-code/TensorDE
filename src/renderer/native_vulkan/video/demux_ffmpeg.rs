...
// follows av_packet_unref lifetime closely: keep one small reusable buffer and
// release 4K-scale packet payload storage instead of retaining it between frames.
...
include!("demux_ffmpeg/packet_stream.rs");
