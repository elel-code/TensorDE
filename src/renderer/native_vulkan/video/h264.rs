...
pub(in crate::renderer::native_vulkan) fn native_vulkan_h264_profile_has_high_syntax(
    profile_idc: u8,
) -> bool {
    matches!(
        profile_idc,
...
#[cfg(any(feature = "native-vulkan-video", test))]
pub(in crate::renderer::native_vulkan) fn native_vulkan_h264_profile_idc_label(
    profile_idc: u8,
) -> &'static str {
    match profile_idc {
        66 => "baseline",
...
#[cfg(any(feature = "native-vulkan-video", test))]
pub(in crate::renderer::native_vulkan) fn native_vulkan_h264_profile_is_8bit_420_decode_candidate(
    profile_idc: u8,
) -> bool {
    matches!(profile_idc, 66 | 77 | 100)
}

pub(in crate::renderer::native_vulkan) fn native_vulkan_h264_std_profile_idc(
    profile_idc: u8,
