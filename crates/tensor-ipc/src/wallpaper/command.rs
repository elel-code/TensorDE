...
pub fn help_text() -> String {
    [
        "usage:",
        "  tensor-msg wallpaper ping",
        "  tensor-msg wallpaper status",
        "  tensor-msg wallpaper status --decisions-csv [--from-file <status.json>]",
        "  tensor-msg wallpaper status --telemetry-csv [--from-file <status.json>]",
        "  tensor-msg wallpaper outputs",
        "  tensor-msg wallpaper watch",
        "  tensor-msg wallpaper properties get [key] [--output <name>]",
        "  tensor-msg wallpaper properties set <key> <value-json> [--output <name>]",
        "  tensor-msg wallpaper properties unset <key> [--output <name>]",
        "  tensor-msg wallpaper set <wallpaper.gwp|wallpaper.gwpdir> [--output <name>] [--variant <id>]",
        "  tensor-msg wallpaper pause [--output <name>]",
        "  tensor-msg wallpaper resume [--output <name>]",
        "  tensor-msg wallpaper stop [--output <name>]",
    ]
    .join("\n")
}
