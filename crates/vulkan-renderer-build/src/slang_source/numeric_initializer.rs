//! Explicit Slang constructors for generated integer initializers.
//!
//! Wallpaper Engine's generated stage dialect accepts legacy numeric coercions
//! such as `int flag = step(...)`. Slang diagnoses the implicit
...
/// exact scalar symbol. Nested/unknown expressions remain Slang errors
