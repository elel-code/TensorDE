...
Tensor Files performance work follows Dolphin first. The local Dolphin source tree at
...
- the matching Tensor Files module or code path;
- any deliberate divergence and why it is needed for Tensor Files's native Vulkan shell;
...
- Tensor Files mapping: src/ui/... or src/core/...
- Divergence: ...
- Verification: ...
```
...
- Are new caches, queues, or retained resources bounded and invalidated at the
  same lifecycle boundary as the Dolphin reference or a justified Tensor Files boundary?
