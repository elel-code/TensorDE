...
audio_output_write_calls="$(jq -r '(.audio_clock.audio_output_write_calls // 0)' "$runtime_json")"
audio_output_write_waits="$(jq -r '(.audio_clock.audio_output_write_waits // 0)' "$runtime_json")"
...
if [[ "$audio_clock_gate_failed" -ne 0 ]]; then
  {
    ...
    printf 'audio_output_write_calls: %s\n' "$audio_output_write_calls"
    printf 'audio_output_write_waits: %s\n' "$audio_output_write_waits"
