...
write_telemetry_summary() {
  ...
  awk -F, '
    NR == 1 { next }
    {
      ...
      renderer_static_surface_resource_references = $74 + 0
      renderer_static_surface_resource_bytes = $75 + 0
      renderer_slideshow_resource_references = $76 + 0
      renderer_slideshow_resource_bytes = $77 + 0
      renderer_static_surface_unique_resources = $78 + 0
      renderer_static_surface_unique_resource_bytes = $79 + 0
      renderer_slideshow_unique_resources = $80 + 0
      renderer_slideshow_unique_resource_bytes = $81 + 0
      static_image_cache_entries = $82 + 0
      static_image_cache_max_entries = $83 + 0
      static_image_cache_generations = $84 + 0
      static_image_cache_reuses = $85 + 0
      static_image_cache_generation_errors = $86 + 0
      static_image_cache_evictions = $87 + 0
      static_image_cache_eviction_errors = $88 + 0
      planned_video_source_references = $89 + 0
      planned_unique_video_sources = $90 + 0
      planned_duplicate_video_source_references = $91 + 0
      planned_max_video_source_outputs = $92 + 0
      planned_video_source_reference_bytes = $93 + 0
      planned_unique_video_source_bytes = $94 + 0
      renderer_video_pipeline_source_references = $95 + 0
      renderer_video_pipeline_source_reference_bytes = $96 + 0
      renderer_video_pipeline_unique_sources = $97 + 0
      renderer_video_pipeline_unique_source_bytes = $98 + 0
      package_cache_max_retained_unique_resource_bytes = $99 + 0
      static_image_cache_bytes = $100 + 0
      static_image_cache_max_bytes = $101 + 0
      package_cache_retained_preview_resource_references = $102 + 0
      package_cache_retained_unique_preview_resources = $103 + 0
      package_cache_retained_preview_resource_bytes = $104 + 0
      package_cache_retained_unique_preview_resource_bytes = $105 + 0
      ...
      last_package_cache_max_retained_unique_resource_bytes = package_cache_max_retained_unique_resource_bytes
      ...
      last_static_image_cache_entries = static_image_cache_entries
      last_static_image_cache_max_entries = static_image_cache_max_entries
      last_static_image_cache_bytes = static_image_cache_bytes
      last_static_image_cache_max_bytes = static_image_cache_max_bytes
      last_static_image_cache_generations = static_image_cache_generations
      last_static_image_cache_reuses = static_image_cache_reuses
      last_static_image_cache_generation_errors = static_image_cache_generation_errors
      last_static_image_cache_evictions = static_image_cache_evictions
      last_static_image_cache_eviction_errors = static_image_cache_eviction_errors
      last_planned_video_source_references = planned_video_source_references
      last_planned_unique_video_sources = planned_unique_video_sources
      last_planned_duplicate_video_source_references = planned_duplicate_video_source_references
      last_planned_max_video_source_outputs = planned_max_video_source_outputs
      last_planned_video_source_reference_bytes = planned_video_source_reference_bytes
      last_planned_unique_video_source_bytes = planned_unique_video_source_bytes
      last_renderer_video_pipeline_source_references = renderer_video_pipeline_source_references
      last_renderer_video_pipeline_source_reference_bytes = renderer_video_pipeline_source_reference_bytes
      last_renderer_video_pipeline_unique_sources = renderer_video_pipeline_unique_sources
      last_renderer_video_pipeline_unique_source_bytes = renderer_video_pipeline_unique_source_bytes
      ...
      last_package_cache_retained_preview_resource_references = package_cache_retained_preview_resource_references
      last_package_cache_retained_unique_preview_resources = package_cache_retained_unique_preview_resources
      last_package_cache_retained_preview_resource_bytes = package_cache_retained_preview_resource_bytes
      last_package_cache_retained_unique_preview_resource_bytes = package_cache_retained_unique_preview_resource_bytes
      ...
      last_renderer_static_surface_resource_references = renderer_static_surface_resource_references
      last_renderer_static_surface_resource_bytes = renderer_static_surface_resource_bytes
      last_renderer_slideshow_resource_references = renderer_slideshow_resource_references
    ...
    END {
      ...
      if (rows > 0) {
        ...
        printf "render_sync_package_cache_max_retained_unique_resource_bytes_latest: %d\n", last_package_cache_max_retained_unique_resource_bytes
        ...
        printf "render_sync_static_image_cache_entries_latest: %d\n", last_static_image_cache_entries
        printf "render_sync_static_image_cache_max_entries_latest: %d\n", last_static_image_cache_max_entries
        printf "render_sync_static_image_cache_bytes_latest: %d\n", last_static_image_cache_bytes
        printf "render_sync_static_image_cache_max_bytes_latest: %d\n", last_static_image_cache_max_bytes
        printf "render_sync_static_image_cache_generations_latest: %d\n", last_static_image_cache_generations
        printf "render_sync_static_image_cache_reuses_latest: %d\n", last_static_image_cache_reuses
        printf "render_sync_static_image_cache_generation_errors_latest: %d\n", last_static_image_cache_generation_errors
        printf "render_sync_static_image_cache_evictions_latest: %d\n", last_static_image_cache_evictions
        printf "render_sync_static_image_cache_eviction_errors_latest: %d\n", last_static_image_cache_eviction_errors
        printf "render_sync_planned_video_source_references_latest: %d\n", last_planned_video_source_references
        printf "render_sync_planned_unique_video_sources_latest: %d\n", last_planned_unique_video_sources
        printf "render_sync_planned_duplicate_video_source_references_latest: %d\n", last_planned_duplicate_video_source_references
        printf "render_sync_planned_max_video_source_outputs_latest: %d\n", last_planned_max_video_source_outputs
        printf "render_sync_planned_video_source_reference_bytes_latest: %d\n", last_planned_video_source_reference_bytes
        printf "render_sync_planned_unique_video_source_bytes_latest: %d\n", last_planned_unique_video_source_bytes
        printf "renderer_video_pipeline_source_references_latest: %d\n", last_renderer_video_pipeline_source_references
        printf "renderer_video_pipeline_source_reference_bytes_latest: %d\n", last_renderer_video_pipeline_source_reference_bytes
        printf "renderer_video_pipeline_unique_sources_latest: %d\n", last_renderer_video_pipeline_unique_sources
        printf "renderer_video_pipeline_unique_source_bytes_latest: %d\n", last_renderer_video_pipeline_unique_source_bytes
        ...
        printf "render_sync_package_cache_retained_preview_resource_references_latest: %d\n", last_package_cache_retained_preview_resource_references
        printf "render_sync_package_cache_retained_unique_preview_resources_latest: %d\n", last_package_cache_retained_unique_preview_resources
        printf "render_sync_package_cache_retained_preview_resource_bytes_latest: %d\n", last_package_cache_retained_preview_resource_bytes
        printf "render_sync_package_cache_retained_unique_preview_resource_bytes_latest: %d\n", last_package_cache_retained_unique_preview_resource_bytes
        ...
        printf "renderer_static_surface_resource_bytes_latest: %d\n", last_renderer_static_surface_resource_bytes
        printf "renderer_slideshow_resource_references_latest: %d\n", last_renderer_slideshow_resource_references
...
has_telemetry_expectations() {
  [[ "$expect_render_sync_cache_hit" -eq 1 ||
    ...
    -n "$expect_render_sync_package_cache_retained_preview_resource_references_latest_at_most" ||
    -n "$expect_render_sync_package_cache_retained_unique_preview_resources_latest_at_most" ||
    -n "$expect_render_sync_package_cache_retained_preview_resource_bytes_latest_at_most" ||
    -n "$expect_render_sync_package_cache_retained_unique_preview_resource_bytes_latest_at_most" ||
    ...
    -n "$expect_renderer_static_surface_resource_references_latest_at_most" ||
    ...
    -n "$expect_renderer_slideshow_unique_resource_bytes_latest_at_most" ||
...
validate_telemetry_expectations() {
  ...
  if [[ -n "$expect_render_sync_package_cache_retained_preview_resource_references_latest_at_most" ]]; then
    expect_telemetry_maximum "render_sync_package_cache_retained_preview_resource_references_latest" "$expect_render_sync_package_cache_retained_preview_resource_references_latest_at_most" "latest retained package-cache preview resource references"
  fi
  if [[ -n "$expect_render_sync_package_cache_retained_unique_preview_resources_latest_at_most" ]]; then
    expect_telemetry_maximum "render_sync_package_cache_retained_unique_preview_resources_latest" "$expect_render_sync_package_cache_retained_unique_preview_resources_latest_at_most" "latest retained package-cache unique preview resources"
  fi
  if [[ -n "$expect_render_sync_package_cache_retained_preview_resource_bytes_latest_at_most" ]]; then
    expect_telemetry_maximum "render_sync_package_cache_retained_preview_resource_bytes_latest" "$expect_render_sync_package_cache_retained_preview_resource_bytes_latest_at_most" "latest retained package-cache preview resource bytes"
  fi
  if [[ -n "$expect_render_sync_package_cache_retained_unique_preview_resource_bytes_latest_at_most" ]]; then
    expect_telemetry_maximum "render_sync_package_cache_retained_unique_preview_resource_bytes_latest" "$expect_render_sync_package_cache_retained_unique_preview_resource_bytes_latest_at_most" "latest retained package-cache unique preview resource bytes"
  fi
  ...
  if [[ -n "$expect_renderer_static_surface_resource_references_latest_at_most" ]]; then
    expect_telemetry_maximum "renderer_static_surface_resource_references_latest" "$expect_renderer_static_surface_resource_references_latest_at_most" "latest renderer static surface resource references"
  fi
  if [[ -n "$expect_renderer_static_surface_resource_bytes_latest_at_most" ]]; then
    expect_telemetry_maximum "renderer_static_surface_resource_bytes_latest" "$expect_renderer_static_surface_resource_bytes_latest_at_most" "latest renderer static surface resource bytes"
  fi
  if [[ -n "$expect_renderer_static_surface_unique_resources_latest_at_most" ]]; then
    expect_telemetry_maximum "renderer_static_surface_unique_resources_latest" "$expect_renderer_static_surface_unique_resources_latest_at_most" "latest renderer static surface unique resources"
  fi
  ...
  if [[ -n "$expect_renderer_slideshow_resource_bytes_latest_at_most" ]]; then
    expect_telemetry_maximum "renderer_slideshow_resource_bytes_latest" "$expect_renderer_slideshow_resource_bytes_latest_at_most" "latest renderer slideshow resource bytes"
  fi
  if [[ -n "$expect_renderer_slideshow_unique_resources_latest_at_most" ]]; then
    expect_telemetry_maximum "renderer_slideshow_unique_resources_latest" "$expect_renderer_slideshow_unique_resources_latest_at_most" "latest renderer slideshow unique resources"
  fi
  if [[ -n "$expect_renderer_slideshow_unique_resource_bytes_latest_at_most" ]]; then
    expect_telemetry_maximum "renderer_slideshow_unique_resource_bytes_latest" "$expect_renderer_slideshow_unique_resource_bytes_latest_at_most" "latest renderer slideshow unique resource bytes"
  fi
