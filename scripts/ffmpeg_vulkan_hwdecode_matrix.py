...
DEFAULT_CODEC_SOURCES = {
    "h264": "artifacts/video-sources/h264/h264-high-b0-ref2-weightp0-weightb0-3840x2160-240fps-2402frames-g2401-d2400.mp4",
    "h265-main8": "artifacts/video-sources/h265/h265-main-8-b0-ref1-3840x2160-240fps-2402frames-g240-d2400.mp4",
    "h265-main10": "artifacts/video-sources/h265/h265-main-10-b0-ref1-3840x2160-240fps-566frames-g240-d240.mp4",
    "av1-main8": "artifacts/video-sources/av1/av1-main8-3840x2160-240fps-566frames-g240.webm",
    "av1-main10": "artifacts/video-sources/av1/av1-main10-3840x2160-240fps-566frames-g240.webm",
}
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--all-video-sources",
        action="store_true",
        help="Scan artifacts/video-sources recursively.",
    )
...
def selected_sources(args: argparse.Namespace, repo_root: Path) -> list[Path]:
    ...
    if args.all_video_sources:
        sources.extend(scan_media_dir(repo_root / "artifacts/video-sources"))
