#!/usr/bin/env python3
"""Run GPU video decode and presentation matrices with dgop memory sampling."""
...
DEFAULT_CODEC_SOURCES = {
    "h264": "artifacts/tensor-wallpaper/video-sources/h264/h264-high-b0-ref2-weightp0-weightb0-3840x2160-240fps-2402frames-g2401-d2400.mp4",
    "h265-main8": "artifacts/tensor-wallpaper/video-sources/h265/h265-main-8-b0-ref1-3840x2160-240fps-2402frames-g240-d2400.mp4",
    "h265-main10": "artifacts/tensor-wallpaper/video-sources/h265/h265-main-10-b0-ref1-3840x2160-240fps-566frames-g240-d240.mp4",
    "av1-main8": "artifacts/tensor-wallpaper/video-sources/av1/av1-main8-3840x2160-240fps-566frames-g240.webm",
    "av1-main10": "artifacts/tensor-wallpaper/video-sources/av1/av1-main10-3840x2160-240fps-566frames-g240.webm",
}
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run GPU video decode sources and collect dgop memory plus "
            "present telemetry."
        )
    )
    ...
    parser.add_argument(
        "--all-video-sources",
        action="store_true",
        help="Scan artifacts/tensor-wallpaper/video-sources recursively.",
    )
    ...
    parser.add_argument("--artifact-prefix", default="tensor-wallpaper-video-decode")
    parser.add_argument("--binary", default="target/release/tensor-wallpaper")
...
def selected_sources(args: argparse.Namespace, repo_root: Path) -> list[Path]:
    ...
    if args.all_video_sources:
        sources.extend(scan_media_dir(repo_root / "artifacts/tensor-wallpaper/video-sources"))
