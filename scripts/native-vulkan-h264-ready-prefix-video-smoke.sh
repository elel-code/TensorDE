...
h264_present_result_wait_count="$(jq -r '(.h264_retained_video_present_decode.decoded_image_present_sequence.latest_draw.present_wait2_available // false) | if . then 1 else 0 end' "$runtime_json")"
