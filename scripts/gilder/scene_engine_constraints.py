...
def main() -> int:
    ...
    architecture_doc = read_text(DOCS_ROOT / "gilder-scene-engine-architecture.md")
    ...
    required = [
        ...
        WORKSPACE_ROOT / "scripts/gilder/scene_engine_cli_smoke.py",
        WORKSPACE_ROOT / "scripts/gilder/scene_engine_runtime_smoke.py",
    ]
